...
import mylibr.Controler;


public class giuxe {
    static File FileData = new File("src\\dto\\data.txt").getAbsoluteFile();
    static File FileDataHistory = new File("src\\dto\\history.txt").getAbsoluteFile();
    static File FileDataDeleted = new File("src\\dto\\dataDeleted.txt").getAbsoluteFile();
    ...
    static File Fileravao = new File("src\\dto\\Ra,vao.txt").getAbsoluteFile();
    static File FileAccount = new File("src\\dto\\Account.txt").getAbsoluteFile();
    ...
    static String ID_CARD = null;
    static String ID_CARD_2 = null;
...
//        but.setIcon(new ImageIcon("C:\\Users\\HoangDeShotgun\\IdeaProjects\\RIFD Card\\src\\icon\\register.png"));
        ...
        but4.addActionListener(e -> {
            ...
            if(ID_CARD != null || ID_CARD_2 != null){
                ...
                if(con.checkcard(ID_CARD, FileData)) suaThongTincardProperty = con.getData(ID_CARD, FileData).split("_");
                else if(con.checkcard(ID_CARD_2, FileData)) suaThongTincardProperty = con.getData(ID_CARD_2, FileData).split("_");
                
                //119_Cần Ngọc Ánh_86B7-50016_Nữ_null_Sat May 14 16:55:10 ICT 2022_0000487912.

                suaThongTinField0.setText(suaThongTincardProperty[1]);
                suaThongTinField1.setText(suaThongTincardProperty[3]);
                suaThongTinField2.setText(suaThongTincardProperty[0]);
                suaThongTinField3.setText(suaThongTincardProperty[2]);
                suaThongTinField4.setText(suaThongTincardProperty[4]);
        ...
        quetTheNgay_hienThi.setBounds(523, 585, 448, 37);
...
//        JButton suaThongTinButton,getSuaThongTinReturnButton;
        ...
        suaThongTinThe.setBounds(100, 0, 1360, 768);//x axis, y axis, width, height
        ...
        suaThongTinField0 = new JTextField();
        suaThongTinField0.setBounds(400, 156, 564, 44);
        suaThongTinField1 = new JTextField();
        suaThongTinField1.setBounds(400, 221, 564, 44);
        suaThongTinField2 = new JTextField();
        suaThongTinField2.setBounds(400, 298, 564, 44);
        suaThongTinField3 = new JTextField();
        suaThongTinField3.setBounds(400, 373, 564, 44);
        suaThongTinField4 = new JTextField();
        suaThongTinField4.setBounds(400, 445, 564, 44);
        
        suaThongTinButton.setFont(new Font("", Font.PLAIN, 30));
        suaThongTinButton.setBounds(587, 608, 520, 104);//x axis, y axis, width, height

        
        suaThongTinThe.add(tieude);
        suaThongTinThe.add(suaThongTinshow0);
        suaThongTinThe.add(suaThongTinshow1);
        suaThongTinThe.add(suaThongTinshow2);
        suaThongTinThe.add(suaThongTinshow3);
        suaThongTinThe.add(suaThongTinshow4);
        suaThongTinThe.add(suaThongTinField0);
        suaThongTinThe.add(suaThongTinField1);
        suaThongTinThe.add(suaThongTinField2);
        suaThongTinThe.add(suaThongTinField3);
        suaThongTinThe.add(suaThongTinField4);
